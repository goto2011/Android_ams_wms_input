...
// --- NativeInputManager ---
// dg2: 类: NativeInputManager对象. 
// 实现 InputReaderPolicyInterface 和 InputDispatcherPolicyInterface.
...
private:
	...
	// dg2: 指向Java层的IMS对象
    jobject mServiceObj;
	// dg2: 指向“android.display”线程的Looper
    sp<Looper> mLooper;
...
NativeInputManager::NativeInputManager(jobject contextObj,
	...
	// add inputmanager, 并命名为 inputflinger.
